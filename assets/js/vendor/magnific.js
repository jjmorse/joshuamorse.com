  ...
  MagnificPopup.prototype = {
    ...
    _close: function() {
      ...
      try {
        ...
        console.log("Error reverting pushState: " + e);
      }
    },
    ...
    parseEl: function(index) {
      ...
      if(item.el) {
        ...
        try {
          document.title = document.title + " - " + item.el.context.innerText.split('\n')[0];
          window.history.pushState(item.src,document.title + " - " + item.el.context.innerText.split('\n')[0],item.el.context.baseURI + '#' + item.el.context.pathname);
        }
        catch (e) {
          console.log("Error pushing state: " + e);
        }
